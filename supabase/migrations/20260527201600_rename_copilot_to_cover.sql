...
ALTER POLICY "Users can manage their own copilot messages" ON public.cover_messages RENAME TO "Users can manage their own rover messages";
ALTER POLICY "Admins can view abuse logs" ON public.cover_abuse_logs RENAME TO "Admins can view rover abuse logs";
