      ...
      <section className="relative py-20 px-4 bg-gradient-to-br from-blue-600 via-purple-600 to-purple-700 text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center space-y-8">
          <Badge variant="secondary" className="mx-auto bg-white/20 text-white border-white/30">
            ...
            Analise seu currículo com IA, explore oportunidades de estágio e aprimore suas habilidades para conquistar o mercado de trabalho.
            </p>
          ...
          <div className="flex justify-center items-center space-x-8 pt-8 text-blue-200">
            ...
            <div className="text-center">
              ...
              <div className="text-sm">Agencias Cadastradas</div>
            </div>
            <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="relative overflow-hidden group hover:shadow-2xl transition-shadow border-2 border-pink-400/40">
              ...
              <CardHeader className="relative">
                ...
                <CardTitle className="text-xl text-pink-600 dark:text-pink-400">Análise de Currículo com IA</CardTitle>
            ...
            <Card className="relative overflow-hidden group hover:shadow-2xl transition-shadow border-2 border-blue-400/40">
              ...
              <CardHeader className="relative">
                ...
                <CardTitle className="text-xl text-blue-700 dark:text-blue-400">Mapa de Agências</CardTitle>
                <CardDescription className="text-slate-700 dark:text-slate-200">
            ...
            <Card className="relative overflow-hidden group hover:shadow-2xl transition-shadow border-2 border-purple-400/40">
              ...
              <CardHeader className="relative">
                ...
                <CardTitle className="text-xl text-purple-700 dark:text-purple-400">Calculadora de Recesso de Estágio</CardTitle>
                <CardDescription className="text-slate-700 dark:text-slate-200">
              ...
              <CardContent className="relative">
                ...
                <Button variant="outline" className="w-full border-purple-400 text-purple-700 dark:text-purple-400 font-bold" asChild>
            ...
            <Card className="relative overflow-hidden group hover:shadow-2xl transition-shadow border-2 border-yellow-400/40">
              ...
              <CardHeader className="relative">
                ...
                <div className="flex items-center gap-2">
                  <CardTitle className="text-xl text-yellow-600 dark:text-yellow-400">Simulador de Entrevistas</CardTitle>
              ...
              <CardContent className="relative">
                ...
                <Button variant="outline" className="w-full opacity-70 cursor-not-allowed border-yellow-400 text-yellow-700 dark:text-yellow-400">
                  Em Desenvolvimento
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </CardContent>
            ...
            <Card className="relative overflow-hidden group hover:shadow-2xl transition-shadow border-2 border-rose-400/40">
              ...
              <CardHeader className="relative">
                ...
                <div className="flex items-center gap-2">
                  <CardTitle className="text-xl text-rose-700 dark:text-rose-400">Gerador de Currículos</CardTitle>
                  <Badge variant="secondary" className="bg-yellow-400 text-purple-900">
                    Em breve
                  </Badge>
                </div>
              ...
              <CardContent className="relative">
                ...
                <Button variant="outline" className="w-full opacity-70 cursor-not-allowed border-rose-400 text-rose-700 dark:text-rose-400">
                  Em Desenvolvimento
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </CardContent>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-white">IA Especializada</h3>
              <p className="text-slate-200 dark:text-slate-100">
                Tecnologia avançada treinada especificamente para análise de currículos e orientação de carreira estudantil.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-white">Tecnologia Avançada</h3>
              <p className="text-slate-200 dark:text-slate-100">
                Ferramentas inovadoras que combinam IA, análise de dados e experiência do usuário para resultados precisos.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-white">Comunidade Ativa</h3>
              <p className="text-slate-200 dark:text-slate-100">
                Conecte-se com outros universitários, compartilhe experiências e descubra oportunidades através da nossa rede.
              </p>
            </div>
          </div>
        </div>
...
{/* Testimonials */}
      <section className="py-20 px-4 bg-white dark:bg-gray-900">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-navy-900 dark:text-white mb-4">O que nossos estagiários dizem</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-l-4 border-l-pink-600 dark:bg-gray-800">
              <CardContent className="pt-6">
                ...
                <p className="text-slate-600 dark:text-slate-200 mb-4">
                  "O Estagionauta transformou minha busca por estágio. A revisão de currículo com IA me ajudou muito!"
                </p>
                <div className="font-semibold text-navy-900 dark:text-white">Maria Silva</div>
                <div className="text-sm text-slate-500 dark:text-slate-400">Estagiária de Marketing</div>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-purple-600 dark:bg-gray-800">
              <CardContent className="pt-6">
                ...
                <p className="text-slate-600 dark:text-slate-200 mb-4">
                  "O simulador de entrevistas me deu muita confiança. Consegui minha vaga na primeira tentativa!"
                </p>
                <div className="font-semibold text-navy-900 dark:text-white">João Santos</div>
                <div className="text-sm text-slate-500 dark:text-slate-400">Estagiário de TI</div>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-blue-600 dark:bg-gray-800">
              <CardContent className="pt-6">
                ...
                <p className="text-slate-600 dark:text-slate-200 mb-4">
                  "A calculadora de recesso me ajudou a entender meus direitos. Plataforma incrível!"
                </p>
                <div className="font-semibold text-navy-900 dark:text-white">Ana Costa</div>
                <div className="text-sm text-slate-500 dark:text-slate-400">Estagiária de RH</div>
              </CardContent>
            </Card>
          </div>
        </div>
